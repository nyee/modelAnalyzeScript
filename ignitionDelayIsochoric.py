...
P_list = [20] # Set pressure
T_list = list(range(700,1025,25)) # Set temperature
for P_eff in P_list:
	for T_eff in T_list:
		for index_reaction in index_list:
			gas = ct.Solution('chem_annotated.cti') # Input mech
			air = ct.Solution('air.xml')
			gas.TPX = T_eff, P_eff*1e5, 'pcresol(1):0.02, butane(5):0.98, O2(2):6.54, N2:24.5904' # Set mixture composition (molar ratio)
			...
			t_end = 0.1 # Set end time. Unit: second.
